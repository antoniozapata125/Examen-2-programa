...
public static List<FacturaDetalles> listFacturaDetalle = new ArrayList();
...
do {
            ...
            switch (opcion) {
              ...
              int opcion1=0;
                   ...
                   opcion1 = in.nextInt();
                    ...
                    listFacturaDetalle.add(new FacturaDetalles(Cantida ,Descripcion, valor,total));
                    }}
                    while(opcion1!=1);
           // String Cantida = "null";
      ...
      //2
                    for (FacturaDetalles fact : listFacturaDetalle) {
